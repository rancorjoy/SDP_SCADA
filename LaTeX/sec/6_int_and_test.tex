...
\begin{equation}
V_{in}=V_{analog}\cdot\frac{560\Omega+R_{sense}}{R_{sense}}
\end{equation}

\begin{equation}
V_{in}=4.02~\text{V}\cdot\frac{560\Omega+2.2~k\Omega}{2.2~k\Omega}\approx5.04~\text{V}
\end{equation}
